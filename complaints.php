...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_complaint'])) {
    ...
    if (empty($errors)) {
        try {
            ...
            $success = "Complaint submitted successfully! Reference #COMP" . str_pad($complaint_id, 6, '0', STR_PAD_LEFT);
...
// Function to get complaint details for modal
function getComplaintDetails($db, $complaint_id, $user_id) {
    $stmt = $db->prepare("
        SELECT 
            c.*,
            sp.profession,
...
<head>
    ...
    <title>Complaint Center - <?php echo htmlspecialchars($platform_name); ?></title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="container py-4">
        ...
        <div class="top-bar">
            <div class="welcome-section">
                <div class="welcome-text">
                    <h1><i class="fas fa-flag me-2"></i> Complaint Center</h1>
                    <p>Report issues, track complaints, and help us improve our service quality</p>
                </div>
                ...
                <div class="filter-row">
                    <div class="filter-group">
                        ...
                        <input type="text" name="search" value="<?php echo htmlspecialchars($search); ?>" 
                               class="form-control" placeholder="Search by description or provider...">
                    </div>
                    <div class="filter-group">
        ...
        <div class="card">
            <div class="card-header">
                <h3>Your Complaints (<?php echo $total_complaints; ?>)</h3>
            </div>
                ...
                <form method="POST" enctype="multipart/form-data" id="complaintForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="file-upload-area" id="fileUploadArea">
                            ...
                            <p class="text-muted small">Max file size: 10MB. Supported: images, PDF, documents</p>
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="anonymousReport">
                                Submit anonymously (your name will not be shared with the provider)
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-info">
                        ...
                        <strong>Important:</strong> Please provide accurate and detailed information to help us resolve your complaint effectively.
                    </div>

                    <div class="form-buttons">
                        <button type="submit" name="submit_complaint" class="btn btn-primary">Submit Complaint</button>
                        <button type="button" class="btn btn-secondary" onclick="closeModal('newComplaintModal')">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
                ...
                <form method="POST" id="feedbackForm">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="user_feedback" class="form-control" rows="6" 
                                  placeholder="Add any additional information or updates about your complaint..."></textarea>
                    </div>

                    <div class="form-buttons">
                        <button type="submit" name="update_complaint_status" class="btn btn-primary">Save Feedback</button>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p class="text-muted mb-0">Your trusted platform for quality service providers</p>
                </div>
                <div class="col-md-6 text-md-end">
                    <p class="text-muted mb-0"><?php echo htmlspecialchars($copyright_text); ?></p>
                    <p class="text-muted mb-0">Need help? Contact: <?php echo htmlspecialchars($contact_email); ?></p>
                </div>
            </div>
        </div>
    </footer>
    ...
    <script>
        ...
        function viewComplaintDetails(complaintId) {
            fetch('ajax/get_complaint_details.php?id=' + encodeURIComponent(complaintId))
        ...
        function escalateComplaint(complaintId) {
            if (confirm('Are you sure you want to escalate this complaint? This will prioritize it for immediate review.')) {
                // In a real implementation, this would send an AJAX request
                fetch('ajax/escalate_complaint.php', {
                    method: 'POST',
                    headers: {
                ...
                .then(data => {
                    if (data.success) {
                        alert('Complaint has been escalated!');
                        location.reload();
                    } else {

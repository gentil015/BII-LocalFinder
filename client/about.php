...
$stats = [
    ...
    'clients' => $db->query("
        SELECT COUNT(*) 
        FROM users 
        WHERE user_type = 'client' AND is_verified = 1
    ")->fetchColumn(),
    'bookings' => $db->query("
        SELECT COUNT(*) 
        FROM bookings 
...
// Get districts coverage
$districts_coverage = $db->query("
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../providers.php"><i class="fas fa-search"></i> Find Providers</a>
                    </li>
                    <li class="nav-item">
    ...
    <section class="stats-section">
        <div class="container">
            <h2 class="section-title text-center text-white mb-5">Our Impact in Numbers</h2>
            <div class="row">
                <div class="col-md-3 col-6">
                    <div class="stat-item">
                        <div class="stat-number"><?php echo number_format($stats['providers']); ?>+</div>
                ...
                <div class="col-md-3 col-6">
                    <div class="stat-item">
                        <div class="stat-number"><?php echo number_format($stats['bookings']); ?>+</div>
            ...
            <div class="row mt-4">
                <div class="col-md-4 col-6">
                    <div class="stat-item">
                        <div class="stat-number"><?php echo number_format($featured_providers); ?>+</div>
                        <div class="stat-label">Featured Providers</div>
                    </div>
                </div>
                <div class="col-md-4 col-6">
                    <div class="stat-item">
                ...
                <div class="col-md-4 col-6">
                    <div class="stat-item">
                        <div class="stat-number"><?php echo number_format($districts_coverage); ?>+</div>

...
/**
 * Fake Card Gateway
 * Simulates a card payment flow such as Visa/Mastercard/Stripe.
 */
class FakeCardGateway implements PaymentGateway
{
    ...
    public function pay(array $paymentData): array
    {
        ...
        return [
            ...
            'status' => $status,
            'message' => 'Card payment request submitted',
            'gateway_response' => [
                'transaction_id' => $transactionId,
                'phone_number' => $phone,
    ...
    public function verify(string $transactionId): array
    {
        ...
        if (strpos($transactionId, 'CARD_') !== 0) {
            return [
                'success' => false,
                'verified' => false,
                'status' => 'not_found',
                ...
                'gateway_response' => [
                    ...
                    'error_message' => 'Invalid card transaction ID'
                ]
            ];
        }
